  ...
  return (
    <footer className="bg-primary text-white text-center py-4">
      ...
      <div className="flex justify-center mt-2 space-x-4">
        <Link href="https://www.facebook.com/RogysBakery" target="_blank" className="hover:text-secondary">
          <AiOutlineFacebook className="size-6" />
        </Link>
        <Link href="https://www.instagram.com/rogyscreations/" target="_blank" className="hover:text-secondary">
